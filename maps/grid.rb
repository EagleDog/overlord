...
#
    ...
    # def press_a;  @click_low.play;  end
    # def press_d;  @click_low.play;  end
    # def press_w;  @click_low.play;  end
    # def press_s;  @click_low.play;  end
    # def press_p;  @click_high.play;  end
