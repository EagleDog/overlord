...
class BallObject < ImageWidget 
    ...
    def center_mass;   Point.new(center_x, center_y);     end
    def top_left;        Point.new(@x, @y);             end
    def top_right;       Point.new(right_edge, @y);       end
    def bottom_left;      Point.new(@x, bottom_edge);        end
    def bottom_right;     Point.new(right_edge, bottom_edge);   end
    ...
    def overlaps(proposed_x, proposed_y, other_object)
        # Darren
